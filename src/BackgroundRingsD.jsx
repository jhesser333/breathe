...
export const GATE_SCALE = [1.223, 1.835, 1].map((v) => v * 0.95 * 0.95)   // inhale ring scale (base scale), two successive 5% reductions from the clearance-margin sizing derived above
export const EXHALE_SCALE = GATE_SCALE.map((v) => v * 1.5 * 0.9)   // exhale ring scale: 1.5x inhale, then 10% smaller
