...
const RING_COUNT = 23           // covers TUNNEL_FAR_Z..TUNNEL_NEAR_Z at 4-unit spacing with headroom
const RING_SPACING = 4
const TUNNEL_FAR_Z = -5
const TUNNEL_NEAR_Z = 1          // recycle/disappear point
