  ...
  return (
    <div key={modeKey} style={{ width: '100%', height: '100%', position: 'relative' }}>
      ...
      >
        ...
        {backgroundOption === 'rings' && <RingParticlesD primaryColor={palette.primaryColor} paceProgressRef={ringPaceProgressRef} breathPhaseRef={breathPhaseRef} gatesEnabledRef={gatesEnabledRef} spawnIntervalRef={spawnIntervalRef} inhaleSecondsRef={inhaleSecondsRef} exhaleSecondsRef={exhaleSecondsRef} />}
