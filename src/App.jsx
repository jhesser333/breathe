...
import SlowingDownRingsD from './SlowingDownRingsD'
  ...
  return (
    <div key={modeKey} ref={wrapperRef} style={{ width: '100%', height: '100%', position: 'relative' }}>
      ...
      >
        ...
        {mode === 'slowing' && shapeOption === 'd' && <SlowingDownRingsD gatesEnabledRef={gatesEnabledRef} breathPhaseRef={breathPhaseRef} inhaleSecondsRef={inhaleSecondsRef} exhaleSecondsRef={exhaleSecondsRef} gateColor={palette.secondaryColor} emissiveColor={palette.primaryColor} livePaletteRef={livePaletteRef} />}
